...
var Particle = /*#__PURE__*/function () {
  function Particle(x, y, radius, color, radians) {
    ...
    this.y = y;
    this.radius = radius;
    this.color = color; // Gives a random value from 0 to 2pi
    ...
    this.initialY = y;
    this.velocity = 0.05;
    this.distanceFromCenter = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.randomIntFromRange)(50, 120);
    this.lastMouse = {
      x: x,
      y: y
    };
  ...
  _createClass(Particle, [{
    ...
    value: function update() {
      ...
      this.lastMouse.y += (mouse.y - this.lastMouse.y) * 0.05; // CircularMotion
...
function animate() {
  requestAnimationFrame(animate); // Creates a rectangle to be drawn on top our circles each time the animate loop
